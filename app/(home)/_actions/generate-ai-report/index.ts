...
export const generateAiReport = async ({ month }: GenerateAiReportSchema) => {
  ...
  //mandar as transações para o chatgpt e pedir para ele gerar um relatório com
  if (transactions.length === 0)
    return "Adicione uma transação para gerar o relatório.";
    ...
    messages: [
      {
        role: "system",
        content:
          "Você é um especialista em gestão e orgazinação de finanças pessoais. Você ajuda as pessoas a organizarem melhor as suas finanças.",
      },
      {
        role: "user",
        content,
